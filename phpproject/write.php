    ...
    <body>        
		...
		<div id="container">
            ...
            <form method="post" action="">                 
                <div id = "inputtitle">
                    <input id = "txttitle" type="text" name="title" placeholder="Enter Title" autofocus <?php $h->keepValues($title, 'textbox'); ?>>                    
                </div>
                <div id="message">
                    <textarea name = "post" <?php $h->keepValues($post, 'textarea'); ?>></textarea>
                ...
                <div id="submit-section">        
                    ...
                    <select id = "postoptions" class = "custom-select" name = "audience">
                        <option value = '' <?php if ($msg != 'Message saved successfully') $h->keepValues($audience, 'select', ''); ?>>Available to: </option>
